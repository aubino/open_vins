 ...
 */
#define PRINT_ALL(x...) ov_dai::Printer::debugPrint(ov_dai::Printer::PrintLevel::ALL, __FILE__, TOSTRING(__LINE__), x);
#define PRINT_DEBUG(x...) ov_dai::Printer::debugPrint(ov_dai::Printer::PrintLevel::DEBUG, __FILE__, TOSTRING(__LINE__), x);
#define PRINT_INFO(x...) ov_dai::Printer::debugPrint(ov_dai::Printer::PrintLevel::INFO, __FILE__, TOSTRING(__LINE__), x);
#define PRINT_WARNING(x...) ov_dai::Printer::debugPrint(ov_dai::Printer::PrintLevel::WARNING, __FILE__, TOSTRING(__LINE__), x);
#define PRINT_ERROR(x...) ov_dai::Printer::debugPrint(ov_dai::Printer::PrintLevel::ERROR, __FILE__, TOSTRING(__LINE__), x);
