...
protected : 
    ...
    */
    ...
    // Performs a creening and filtering of the incomming tracing points, we won't just take them raw
    void perform_matching(const std::vector<TrackedFeature> &features0, std::vector<TrackedFeature> &features1, 
